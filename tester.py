...
if __name__ == '__main__':
    ...
    parser.add_argument('--is-reranking', default=False)
    ...
    parser.add_argument('--sysu-model-dir', type=str, metavar='PATH',
                default=osp.join(working_dir, 'logs/sysu_pretrained/beta0.7alpha0.2'))
    parser.add_argument('--regdb-model-dir', type=str, metavar='PATH',
                    default=osp.join(working_dir, 'logs/regdb/beta0.7alpha0.2'))
    main()